...
public class Test
{
    ...
    public void runReport()
    {
        ...
        //------------DATA------------------------------------------
        for (int y=0;y<NumberOfRows;y++)   //Adding data rows
        {
        ...
        //-----------FOOTER------------------------------------------
        for (int y=0;y<1;y++)   //Adding footer rows
        {
        ...
        try
        {
            ...
            fu.writeFile("C:\\Wakkir\\Workspaces\\intelij\\AppOutput\\json","report-"+System.nanoTime()+".html",writer.toString());
        ...
        fu.writeFile("C:\\Wakkir\\Workspaces\\intelij\\AppOutput\\json","data-"+System.nanoTime()+".json",jsonObject.toString());
        //utils.writeFile("E:\\Wakkir\\workspaces\\intellij11\\AppOutput\\json","myjason.rows",rows.toString());
    ...
    {
        System.setProperty("LOG_ROOT","C:\\Wakkir\\Workspaces\\intelij\\AppLogs");
