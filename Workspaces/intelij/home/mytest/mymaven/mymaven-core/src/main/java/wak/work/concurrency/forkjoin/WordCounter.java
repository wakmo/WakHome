package wak.work.concurrency.forkjoin;
/* ......................................................................................... */
...
class Document
{
    ...
    static Document fromFile(File file) //throws IOException
    {
        ...
        //List<Integer> integers = new LinkedList(list1);
        
        //--------------------------------------------------
        //Diamond operation is not supported on jdk 1.6 < 1.7
        //List<String> lines = new LinkedList<>();
        List<String> lines = new LinkedList();
        //--------------------------------------------------
        //--------------------------------------------------
        //try with resources not supported in jdk1.6 < 1.7
        /*
...
public class WordCounter
{
    ...
    */ 
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        {
            startTime = System.currentTimeMillis();
            counts = 0;//wordCounter.countOccurrencesInParallel(folder, args[1]);
            stopTime = System.currentTimeMillis();
